...
public abstract class b {
    ...
    public static final ThreadLocal f5861a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ThreadLocal f5862b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f5861a;
        ...
        ThreadLocal threadLocal2 = f5862b;

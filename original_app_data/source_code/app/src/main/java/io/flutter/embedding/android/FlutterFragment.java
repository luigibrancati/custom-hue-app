...
public class FlutterFragment extends ComponentCallbacksC2736q implements FlutterActivityAndFragmentDelegate.Host, ComponentCallbacks2, FlutterActivityAndFragmentDelegate.DelegateFactory {
    ...
    final AbstractC3785D onBackPressedCallback = new AbstractC3785D(true) { // from class: io.flutter.embedding.android.FlutterFragment.2
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        public <T extends FlutterFragment> T build() {
            try {
                T t10 = (T) this.fragmentClass.getDeclaredConstructor(null).newInstance(null);
                if (t10 != null) {
    ...
    public void onAttach(Context context) {
        ...
        if (getArguments().getBoolean(ARG_SHOULD_AUTOMATICALLY_HANDLE_ON_BACK_PRESSED, false)) {
            requireActivity().getOnBackPressedDispatcher().d(this, this.onBackPressedCallback);
    ...
    public boolean popSystemNavigator() {
        ActivityC2740v activity;
        if (!getArguments().getBoolean(ARG_SHOULD_AUTOMATICALLY_HANDLE_ON_BACK_PRESSED, false) || (activity = getActivity()) == null) {
            return false;
        }
        boolean zIsEnabled = this.onBackPressedCallback.isEnabled();
        if (zIsEnabled) {
            this.onBackPressedCallback.setEnabled(false);
        }
        activity.getOnBackPressedDispatcher().h();
        if (zIsEnabled) {

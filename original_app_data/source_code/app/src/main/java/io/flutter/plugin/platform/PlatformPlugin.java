...
public class PlatformPlugin {
    ...
    public class AnonymousClass2 implements View.OnSystemUiVisibilityChangeListener {
        ...
        public static /* synthetic */ void a(AnonymousClass2 anonymousClass2, int i10) {
            if ((i10 & 4) == 0) {
        ...
        public void onSystemUiVisibilityChange(final int i10) {
            this.val$decorView.post(new Runnable() { // from class: io.flutter.plugin.platform.a
                ...
                public final void run() {
                    PlatformPlugin.AnonymousClass2.a(this.f37605a, i10);
                }
            });
        }
    }
    ...
    public void popSystemNavigator() {
        ...
        if (platformPluginDelegate == null || !platformPluginDelegate.popSystemNavigator()) {
            ...
            if (activity instanceof InterfaceC3789H) {
                ((InterfaceC3789H) activity).getOnBackPressedDispatcher().h();
            } else {
                activity.finish();
            }
        }
    ...
    public void setSystemChromeEnabledSystemUIOverlays(List<PlatformChannel.SystemUiOverlay> list) {
        int i10 = list.isEmpty() ? 5894 : 1798;
    ...
    public void setSystemChromeSystemUIOverlayStyle(PlatformChannel.SystemChromeStyle systemChromeStyle) {
        ...
        T t10 = new T(window, window.getDecorView());
        PlatformChannel.Brightness brightness = systemChromeStyle.statusBarIconBrightness;
        if (brightness != null) {
            int i10 = AnonymousClass3.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$Brightness[brightness.ordinal()];
            if (i10 == 1) {
                t10.b(true);
            } else if (i10 == 2) {
                t10.b(false);
        ...
        if (brightness2 != null) {
            int i11 = AnonymousClass3.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$Brightness[brightness2.ordinal()];
            if (i11 == 1) {
                t10.a(true);
            } else if (i11 == 2) {
                t10.a(false);

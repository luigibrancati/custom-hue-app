...
public abstract class R0 {
    ...
    public static final class a extends CameraCaptureSession.StateCallback {
        ...
        public final List f46707a = new ArrayList();
        ...
        public a(List list) {
            ...
            while (it.hasNext()) {
                ...
                if (!(stateCallback instanceof b)) {
                    this.f46707a.add(stateCallback);
                }
            }
        }
        ...
        public void onActive(CameraCaptureSession cameraCaptureSession) {
            Iterator it = this.f46707a.iterator();
            while (it.hasNext()) {
        ...
        public void onCaptureQueueEmpty(CameraCaptureSession cameraCaptureSession) {
            Iterator it = this.f46707a.iterator();
            while (it.hasNext()) {
                AbstractC6368d.a((CameraCaptureSession.StateCallback) it.next(), cameraCaptureSession);
            }
        }
        ...
        public void onSurfacePrepared(CameraCaptureSession cameraCaptureSession, Surface surface) {
            Iterator it = this.f46707a.iterator();
            while (it.hasNext()) {
                AbstractC6366b.a((CameraCaptureSession.StateCallback) it.next(), cameraCaptureSession, surface);
            }
        }
    }

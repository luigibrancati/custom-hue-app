...
public final class e2 extends DataStoreProvider {
    ...
    public static final ConcurrentHashMap f28426a = new ConcurrentHashMap();
    ...
    public final InterfaceC4099i getDataStore() {
        ...
        return createOrGetDataStore(C4205s.d(j1.k.b(applicationContext, "com.appboy.storage.sessions.messaging_session", null, 4, null)));
    }

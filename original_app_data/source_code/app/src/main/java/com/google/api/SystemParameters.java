...
public final class SystemParameters extends GeneratedMessageLite implements InterfaceC3719h0 {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f31078a[GeneratedMessageLite.g.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f31078a[GeneratedMessageLite.g.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f31078a[GeneratedMessageLite.g.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f31078a[GeneratedMessageLite.g.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f31078a[GeneratedMessageLite.g.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f31078a[GeneratedMessageLite.g.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public final Object dynamicMethod(GeneratedMessageLite.g gVar, Object obj, Object obj2) {
        t0 cVar;
        int i10 = a.f31078a[gVar.ordinal()];
        a aVar = null;
        switch (i10) {
            case 1:
    ...
    public SystemParameterRule getRules(int i10) {
        return (SystemParameterRule) this.rules_.get(i10);
    }
    ...
    public p getRulesOrBuilder(int i10) {
        return (p) this.rules_.get(i10);
    }
    ...
    public static SystemParameters parseDelimitedFrom(InputStream inputStream, D d10) {
        return (SystemParameters) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, d10);
    }

    public static SystemParameters parseFrom(ByteBuffer byteBuffer, D d10) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, d10);
    }

    public static SystemParameters parseFrom(AbstractC3722j abstractC3722j) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3722j);
    }
    ...
    public static SystemParameters parseFrom(AbstractC3722j abstractC3722j, D d10) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3722j, d10);
    }
    ...
    public static SystemParameters parseFrom(byte[] bArr, D d10) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, d10);
    }
    ...
    public static SystemParameters parseFrom(InputStream inputStream, D d10) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, d10);
    }

    public static SystemParameters parseFrom(AbstractC3724k abstractC3724k) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3724k);
    }

    public static SystemParameters parseFrom(AbstractC3724k abstractC3724k, D d10) {
        return (SystemParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3724k, d10);
    }
}

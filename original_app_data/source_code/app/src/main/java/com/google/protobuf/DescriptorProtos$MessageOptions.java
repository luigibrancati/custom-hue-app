...
public final class DescriptorProtos$MessageOptions extends GeneratedMessageLite.ExtendableMessage<DescriptorProtos$MessageOptions, a> implements InterfaceC3719h0 {
    ...
    public static DescriptorProtos$MessageOptions parseDelimitedFrom(InputStream inputStream, D d10) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, d10);
    }

    public static DescriptorProtos$MessageOptions parseFrom(ByteBuffer byteBuffer, D d10) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, d10);
    }

    public static DescriptorProtos$MessageOptions parseFrom(AbstractC3722j abstractC3722j) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3722j);
    }
    ...
    public static DescriptorProtos$MessageOptions parseFrom(AbstractC3722j abstractC3722j, D d10) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3722j, d10);
    }
    ...
    public static DescriptorProtos$MessageOptions parseFrom(byte[] bArr, D d10) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr, d10);
    }
    ...
    public static DescriptorProtos$MessageOptions parseFrom(InputStream inputStream, D d10) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, d10);
    }

    public static DescriptorProtos$MessageOptions parseFrom(AbstractC3724k abstractC3724k) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3724k);
    }

    public static DescriptorProtos$MessageOptions parseFrom(AbstractC3724k abstractC3724k, D d10) {
        return (DescriptorProtos$MessageOptions) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, abstractC3724k, d10);
    }
}

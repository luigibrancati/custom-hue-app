...
public class NotificationDetails implements Serializable {
    ...
    public static NotificationDetails from(Map<String, Object> map) {
        ...
        notificationDetails.f28886id = (Integer) map.get("id");
    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            for (Map<String, Object> map : arrayList) {
                arrayList2.add(new MessageDetails((String) map.get(TEXT), a.a(map.get("timestamp")), readPersonDetails((Map) map.get(PERSON)), (String) map.get(DATA_MIME_TYPE), (String) map.get(DATA_URI)));
            }
        }
        return arrayList2;
    }

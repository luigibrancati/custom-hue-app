...
public abstract class NonBlockingJsonParserBase extends ParserBase {
    ...
    */
    public final java.lang.String _addName(int[] r18, int r19, int r20) {
        /*
    ...
    public final String _findName(int i10, int i11) {
    ...
    public final void _updateTokenLocation() {
        ...
        this._tokenInputTotal = this._currInputProcessed + ((long) (i10 - this._currBufferStart));
    }
    ...
    public final JsonToken _valueCompleteInt(int i10, String str) {
    ...
    public final JsonToken _valueNonStdNumberComplete(int i10) {
    ...
    public JsonLocation getCurrentLocation() {
        ...
        return new JsonLocation(_getSourceReference(), this._currInputProcessed + ((long) (this._inputPtr - this._currBufferStart)), -1L, Math.max(this._currInputRow, this._currInputRowAlt), i10);
    }
    ...
    public final String _findName(int i10, int i11, int i12) {
    ...
    public final String _findName(int i10, int i11, int i12, int i13) {

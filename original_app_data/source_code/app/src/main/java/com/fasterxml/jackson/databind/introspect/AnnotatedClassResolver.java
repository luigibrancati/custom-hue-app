...
public class AnnotatedClassResolver {
    ...
    private static void _addSuperInterfaces(JavaType javaType, List<JavaType> list, boolean z10) {
        Class<?> rawClass = javaType.getRawClass();
        if (z10) {
    ...
    private static void _addSuperTypes(JavaType javaType, List<JavaType> list, boolean z10) {
        Class<?> rawClass = javaType.getRawClass();

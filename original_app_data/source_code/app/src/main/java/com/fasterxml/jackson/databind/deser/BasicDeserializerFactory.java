...
public abstract class BasicDeserializerFactory extends DeserializerFactory implements Serializable {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [com.fasterxml.jackson.databind.deser.BasicDeserializerFactory] */
    ...
    /* JADX WARN: Type inference failed for: r13v2, types: [com.fasterxml.jackson.databind.introspect.AnnotatedWithParams, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r13v3 */
    /* JADX WARN: Type inference failed for: r13v4 */
    /* JADX WARN: Type inference failed for: r13v6 */
    /* JADX WARN: Type inference failed for: r15v1, types: [com.fasterxml.jackson.databind.deser.impl.CreatorCandidate] */
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [com.fasterxml.jackson.databind.introspect.AnnotatedWithParams] */
    /* JADX WARN: Type inference failed for: r1v7 */
    /* JADX WARN: Type inference failed for: r25v0, types: [com.fasterxml.jackson.databind.AnnotationIntrospector] */
    /* JADX WARN: Type inference failed for: r26v0, types: [com.fasterxml.jackson.databind.deser.impl.CreatorCollector] */
    ...
    public void _addDeserializerConstructors(DeserializationContext deserializationContext, BeanDescription beanDescription, VisibilityChecker<?> visibilityChecker, AnnotationIntrospector annotationIntrospector, CreatorCollector creatorCollector, Map<AnnotatedWithParams, BeanPropertyDefinition[]> map) throws InvalidDefinitionException {
        ...
        if (beanDescription2.isNonStaticInnerClass()) {
            return;
        }
        AnnotatedConstructor annotatedConstructorFindDefaultConstructor = beanDescription2.findDefaultConstructor();
        if (annotatedConstructorFindDefaultConstructor != null && (!creatorCollector.hasDefaultCreator() || basicDeserializerFactory2._hasCreatorAnnotation(deserializationContext2, annotatedConstructorFindDefaultConstructor))) {
        ...
        while (true) {
            ...
            JsonCreator.Mode modeFindCreatorAnnotation = annotationIntrospector.findCreatorAnnotation(deserializationContext2.getConfig(), next);
            if (JsonCreator.Mode.DISABLED != modeFindCreatorAnnotation) {
                if (modeFindCreatorAnnotation != null) {
                    int i13 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonCreator$Mode[modeFindCreatorAnnotation.ordinal()];
                    if (i13 == 1) {
                        basicDeserializerFactory2._addExplicitDelegatingCreator(deserializationContext2, beanDescription2, creatorCollector, CreatorCandidate.construct(annotationIntrospector, next, null));
                    } else if (i13 != 2) {
                        basicDeserializerFactory2._addExplicitAnyCreator(deserializationContext2, beanDescription2, creatorCollector, CreatorCandidate.construct(annotationIntrospector, next, map.get(next)));
                    } else {
                        basicDeserializerFactory2._addExplicitPropertyCreator(deserializationContext2, beanDescription2, creatorCollector, CreatorCandidate.construct(annotationIntrospector, next, map.get(next)));
                    }
                    i12++;
        ...
        ?? r02 = basicDeserializerFactory2;
        for (?? r15 : linkedList) {
            int iParamCount = r15.paramCount();
            AnnotatedWithParams annotatedWithParamsCreator = r15.creator();
            if (iParamCount == i10) {
                BeanPropertyDefinition beanPropertyDefinitionPropertyDef = r15.propertyDef(r10);
                if (r02._checkIfCreatorPropertyBased(annotationIntrospector, annotatedWithParamsCreator, beanPropertyDefinitionPropertyDef)) {
                    creatorCollector.addPropertyCreator(annotatedWithParamsCreator, r10, new SettableBeanProperty[]{r02.constructCreatorProperty(deserializationContext2, beanDescription2, r15.paramName(r10), 0, r15.parameter(r10), r15.injection(r10))});
                } else {
                    r02._handleSingleArgumentCreator(creatorCollector, annotatedWithParamsCreator, r10, visibilityChecker2.isCreatorVisible(annotatedWithParamsCreator));
                ...
                ?? r12 = annotatedWithParamsCreator;
                ...
                ?? r53 = r52;
                ?? r162 = r16;
                while (r53 < iParamCount) {
                    AnnotatedParameter parameter = r12.getParameter(r53);
                    BeanPropertyDefinition beanPropertyDefinitionPropertyDef2 = r15.propertyDef(r53);
                    byte b12 = b11;
                    ?? r42 = r53;
                    JacksonInject.Value valueFindInjectableValue = annotationIntrospector.findInjectableValue(parameter);
                    PropertyName fullName = beanPropertyDefinitionPropertyDef2 == null ? propertyName : beanPropertyDefinitionPropertyDef2.getFullName();
                    if (beanPropertyDefinitionPropertyDef2 == null || !beanPropertyDefinitionPropertyDef2.isExplicitlyNamed()) {
                        ...
                        if (valueFindInjectableValue != null) {
                            ...
                            settableBeanPropertyArr[r42 == true ? 1 : 0] = basicDeserializerFactory.constructCreatorProperty(deserializationContext, beanDescription, propertyName2, r42 == true ? 1 : 0, parameter, valueFindInjectableValue);
                        } else {
                            basicDeserializerFactory = this;
                        ...
                        i11 = iParamCount;
                        b10 = b12 == true ? 1 : 0;
                        settableBeanPropertyArr[r42 == true ? 1 : 0] = r02.constructCreatorProperty(deserializationContext, beanDescription, fullName, r42 == true ? 1 : 0, parameter, valueFindInjectableValue);
                        basicDeserializerFactory = this;
                    }
                    int i15 = (r42 == true ? 1 : 0) + 1;
                    b11 = b10;
                    settableBeanPropertyArr2 = settableBeanPropertyArr;
                    iParamCount = i11;
                    r12 = r13;
                    propertyName = null;
                    r02 = basicDeserializerFactory;
                    r53 = i15;
                    r162 = r162;
                }
                ?? r132 = r12;
                ...
                if (r162 <= 0 && i14 <= 0) {
                    r32 = 0;
                } else if (r162 + i14 == i16) {
                    r32 = 0;
                    creatorCollector.addPropertyCreator(r132, false, settableBeanPropertyArr3);
                } else {
                    r32 = 0;
                    r32 = 0;
                    r32 = 0;
                    if (r162 == 0 && i14 + 1 == i16) {
                        creatorCollector.addDelegatingCreator(r132, false, settableBeanPropertyArr3, 0);
                    } else {
                        PropertyName propertyNameFindImplicitParamName = r15.findImplicitParamName(b13 == true ? 1 : 0);
                        if (propertyNameFindImplicitParamName == null || propertyNameFindImplicitParamName.isEmpty()) {
                            deserializationContext2.reportBadTypeDefinition(beanDescription2, "Argument #%d of constructor %s has no property name annotation; must have name when multiple-parameter constructor annotated as Creator", Integer.valueOf(b13 == true ? 1 : 0), r132);
                        }
                    }
                }
        ...
        r02._checkImplicitlyNamedConstructors(deserializationContext2, beanDescription2, visibilityChecker, annotationIntrospector, creatorCollector, linkedList2);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r6v13 */
    /* JADX WARN: Type inference failed for: r6v2, types: [com.fasterxml.jackson.databind.introspect.BeanPropertyDefinition] */
    ...
    public void _addDeserializerFactoryMethods(DeserializationContext deserializationContext, BeanDescription beanDescription, VisibilityChecker<?> visibilityChecker, AnnotationIntrospector annotationIntrospector, CreatorCollector creatorCollector, Map<AnnotatedWithParams, BeanPropertyDefinition[]> map) throws InvalidDefinitionException {
        ...
        while (true) {
            ...
            if (modeFindCreatorAnnotation == null) {
                ...
                if (parameterCount == 0) {
                    ...
                    int i11 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonCreator$Mode[modeFindCreatorAnnotation.ordinal()];
                    if (i11 == 1) {
                        basicDeserializerFactory._addExplicitDelegatingCreator(deserializationContext2, beanDescription2, creatorCollector, CreatorCandidate.construct(annotationIntrospector, next, null));
                    } else if (i11 != 2) {
                        basicDeserializerFactory._addExplicitAnyCreator(deserializationContext2, beanDescription2, creatorCollector, CreatorCandidate.construct(annotationIntrospector, next, map.get(next)));
                    } else {
                        basicDeserializerFactory._addExplicitPropertyCreator(deserializationContext2, beanDescription2, creatorCollector, CreatorCandidate.construct(annotationIntrospector, next, map.get(next)));
                    }
                    i10++;
                }
            }
        ...
        for (CreatorCandidate creatorCandidate : linkedList) {
            ...
            if (iParamCount == 1) {
                ...
                if (basicDeserializerFactory._checkIfCreatorPropertyBased(annotationIntrospector, annotatedWithParamsCreator, beanPropertyDefinitionPropertyDef)) {
                    SettableBeanProperty[] settableBeanPropertyArr2 = new SettableBeanProperty[iParamCount];
                    ...
                    while (i12 < iParamCount) {
                        AnnotatedParameter parameter = annotatedWithParamsCreator.getParameter(i12);
                        ?? r62 = beanPropertyDefinitionArr == null ? annotatedParameter : beanPropertyDefinitionArr[i12];
                        JacksonInject.Value valueFindInjectableValue = annotationIntrospector.findInjectableValue(parameter);
                        PropertyName fullName = r62 == 0 ? annotatedParameter : r62.getFullName();
                        if (r62 == 0 || !r62.isExplicitlyNamed()) {
                            settableBeanPropertyArr = settableBeanPropertyArr2;
                            ...
                            if (valueFindInjectableValue != null) {
                                ...
                                deserializationContext2 = deserializationContext;
                                beanDescription2 = beanDescription;
                                settableBeanPropertyArr[i12] = basicDeserializerFactory.constructCreatorProperty(deserializationContext2, beanDescription2, propertyName, i12, parameter, valueFindInjectableValue);
                            } else {
                                basicDeserializerFactory = this;
                                deserializationContext2 = deserializationContext;
                                beanDescription2 = beanDescription;
                                if (annotationIntrospector.findUnwrappingNameTransformer(parameter) != null) {
                                    basicDeserializerFactory._reportUnwrappedCreatorProperty(deserializationContext2, beanDescription2, parameter);
                            ...
                            i13++;
                            settableBeanPropertyArr = settableBeanPropertyArr2;
                            settableBeanPropertyArr[i12] = basicDeserializerFactory.constructCreatorProperty(deserializationContext2, beanDescription2, fullName, i12, parameter, valueFindInjectableValue);
                            basicDeserializerFactory = this;
                            deserializationContext2 = deserializationContext;
                            beanDescription2 = beanDescription;
                        }
                    ...
                    SettableBeanProperty[] settableBeanPropertyArr3 = settableBeanPropertyArr2;
                    if (i13 > 0 || i14 > 0) {
                        if (i13 + i14 == iParamCount) {
                            creatorCollector.addPropertyCreator(annotatedWithParamsCreator, false, settableBeanPropertyArr3);
                        } else if (i13 == 0 && i14 + 1 == iParamCount) {
                            creatorCollector.addDelegatingCreator(annotatedWithParamsCreator, false, settableBeanPropertyArr3, 0);
                        } else {
                            deserializationContext2.reportBadTypeDefinition(beanDescription2, "Argument #%d of factory method %s has no property name annotation; must have name when multiple-parameter constructor annotated as Creator", Integer.valueOf(annotatedParameter2.getIndex()), annotatedWithParamsCreator);
                        }
                    }
                    annotatedParameter = null;
                } else {
    ...
    public void _addExplicitAnyCreator(DeserializationContext deserializationContext, BeanDescription beanDescription, CreatorCollector creatorCollector, CreatorCandidate creatorCandidate) throws InvalidDefinitionException {
        ...
        BeanPropertyDefinition beanPropertyDefinitionPropertyDef = creatorCandidate.propertyDef(0);
        boolean z11 = (propertyNameExplicitParamName == null && valueInjection == null) ? false : true;
        if (!z11 && beanPropertyDefinitionPropertyDef != null) {
    ...
    public void _addExplicitDelegatingCreator(DeserializationContext deserializationContext, BeanDescription beanDescription, CreatorCollector creatorCollector, CreatorCandidate creatorCandidate) throws InvalidDefinitionException {
        ...
        while (i11 < iParamCount) {
            ...
            if (valueInjection != null) {
                ...
                deserializationContext2 = deserializationContext;
                beanDescription2 = beanDescription;
                settableBeanPropertyArr[i11] = basicDeserializerFactory.constructCreatorProperty(deserializationContext2, beanDescription2, null, i11, annotatedParameterParameter, valueInjection);
            } else {
                basicDeserializerFactory = this;
                deserializationContext2 = deserializationContext;
                beanDescription2 = beanDescription;
                if (i10 < 0) {
                    ...
                    deserializationContext2.reportBadTypeDefinition(beanDescription2, "More than one argument (#%d and #%d) left as delegating for Creator %s: only one allowed", Integer.valueOf(i10), Integer.valueOf(i11), creatorCandidate);
                }
            }
            i11++;
    ...
    public void _addExplicitPropertyCreator(DeserializationContext deserializationContext, BeanDescription beanDescription, CreatorCollector creatorCollector, CreatorCandidate creatorCandidate) throws InvalidDefinitionException {
        ...
        while (i10 < iParamCount) {
            ...
            DeserializationContext deserializationContext2 = deserializationContext;
            BeanDescription beanDescription2 = beanDescription;
            settableBeanPropertyArr[i10] = basicDeserializerFactory.constructCreatorProperty(deserializationContext2, beanDescription2, propertyNameParamName, i10, annotatedParameterParameter, valueInjection);
            i10++;
            this = basicDeserializerFactory;
            deserializationContext = deserializationContext2;
            beanDescription = beanDescription2;
    ...
    public SettableBeanProperty constructCreatorProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, PropertyName propertyName, int i10, AnnotatedParameter annotatedParameter, JacksonInject.Value value) throws InvalidDefinitionException {
        DeserializationConfig config = deserializationContext.getConfig();
        AnnotationIntrospector annotationIntrospector = deserializationContext.getAnnotationIntrospector();
        ...
        CreatorProperty creatorPropertyConstruct = CreatorProperty.construct(propertyName, javaTypeResolveMemberAndTypeAnnotations, std.getWrapperName(), typeDeserializerFindTypeDeserializer, beanDescription.getClassAnnotations(), annotatedParameter, i10, value, _getSetterInfo(deserializationContext, std, propertyMetadataConstruct));
    ...
    public JsonDeserializer<?> createArrayDeserializer(DeserializationContext deserializationContext, ArrayType arrayType, BeanDescription beanDescription) throws InvalidDefinitionException {
        DeserializationConfig config = deserializationContext.getConfig();
    ...
    */
    ...
    @Override // com.fasterxml.jackson.databind.deser.DeserializerFactory
    public JsonDeserializer<?> createCollectionLikeDeserializer(DeserializationContext deserializationContext, CollectionLikeType collectionLikeType, BeanDescription beanDescription) throws InvalidDefinitionException {
    ...
    */
    ...
    @Override // com.fasterxml.jackson.databind.deser.DeserializerFactory
    public JsonDeserializer<?> createMapLikeDeserializer(DeserializationContext deserializationContext, MapLikeType mapLikeType, BeanDescription beanDescription) throws InvalidDefinitionException {
    ...
    @Override // com.fasterxml.jackson.databind.deser.DeserializerFactory
    public JsonDeserializer<?> createReferenceDeserializer(DeserializationContext deserializationContext, ReferenceType referenceType, BeanDescription beanDescription) throws InvalidDefinitionException {
    ...
    public TypeDeserializer findPropertyTypeDeserializer(DeserializationConfig deserializationConfig, JavaType javaType, AnnotatedMember annotatedMember) throws InvalidDefinitionException {
    ...
    @Override // com.fasterxml.jackson.databind.deser.DeserializerFactory
    public TypeDeserializer findTypeDeserializer(DeserializationConfig deserializationConfig, JavaType javaType) throws InvalidDefinitionException {

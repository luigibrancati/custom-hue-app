...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public <T> T reportBadDefinition(JavaType javaType, String str, Throwable th) throws InvalidDefinitionException {
    ...
    public <T> T reportBadDefinition(Class<?> cls, String str, Throwable th) throws InvalidDefinitionException {

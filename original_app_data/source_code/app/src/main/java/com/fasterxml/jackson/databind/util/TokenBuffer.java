...
public class TokenBuffer extends JsonGenerator {
    ...
    public static final class Parser extends ParserMinimalBase {
        ...
        public int _convertNumberToInt(Number number) throws InputCoercionException {
        ...
        public long _convertNumberToLong(Number number) throws InputCoercionException {
            if (number instanceof BigInteger) {
                BigInteger bigInteger = (BigInteger) number;
    ...
    public static TokenBuffer asCopyOfValue(JsonParser jsonParser) throws JsonGenerationException {
    ...
    public TokenBuffer append(TokenBuffer tokenBuffer) throws JsonGenerationException {
    ...
    public TokenBuffer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws JsonGenerationException, JsonMappingException {
        ...
        while (true) {
            try {
                ...
                if (i10 < 100) {
                    ...
                    sb2.append(jsonTokenNextToken.toString());
                    if (jsonTokenNextToken == JsonToken.FIELD_NAME) {
                        sb2.append('(');
                        sb2.append(jsonParserAsParser.getCurrentName());
                        sb2.append(')');
                    }
                }
                i10++;

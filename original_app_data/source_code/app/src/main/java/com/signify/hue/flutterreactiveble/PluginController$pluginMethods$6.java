...
public final /* synthetic */ class PluginController$pluginMethods$6 extends AbstractC4860q implements vc.p {
    ...
    public final void invoke(MethodCall p02, MethodChannel.Result p12) {
        ...
        ((PluginController) this.receiver).disconnectFromDevice(p02, p12);
    }
}

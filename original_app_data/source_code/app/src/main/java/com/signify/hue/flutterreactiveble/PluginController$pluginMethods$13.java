...
public final /* synthetic */ class PluginController$pluginMethods$13 extends AbstractC4860q implements vc.p {
    ...
    public final void invoke(MethodCall p02, MethodChannel.Result p12) {
        ...
        ((PluginController) this.receiver).requestConnectionPriority(p02, p12);
    }
}

...
public class IceCandidate {
    ...
    public String toString() {
        return this.sdpMid + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + this.sdpMLineIndex + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + this.sdp + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + this.serverUrl + TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER + this.adapterType.toString();
    }

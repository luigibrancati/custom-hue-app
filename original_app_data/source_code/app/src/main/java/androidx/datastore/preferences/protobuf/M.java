...
public abstract class M {
    ...
    public static final char[] f22729a;
    ...
    public static boolean b(Object obj) {
        return obj instanceof Boolean ? !((Boolean) obj).booleanValue() : obj instanceof Integer ? ((Integer) obj).intValue() == 0 : obj instanceof Float ? Float.floatToRawIntBits(((Float) obj).floatValue()) == 0 : obj instanceof Double ? Double.doubleToRawLongBits(((Double) obj).doubleValue()) == 0 : obj instanceof String ? obj.equals("") : obj instanceof AbstractC2700f ? obj.equals(AbstractC2700f.f22793b) : obj instanceof K ? obj == ((K) obj).getDefaultInstanceForType() : (obj instanceof Enum) && ((Enum) obj).ordinal() == 0;
    }
    ...
    public static void d(StringBuilder sb2, int i10, String str, Object obj) {
        ...
        if (obj instanceof AbstractC2700f) {
            sb2.append(": \"");
            sb2.append(e0.a((AbstractC2700f) obj));
            sb2.append(JsonFactory.DEFAULT_QUOTE_CHAR);
            return;
        }
        if (obj instanceof AbstractC2713t) {
            sb2.append(" {");
            e((AbstractC2713t) obj, sb2, i10 + 2);
            sb2.append("\n");
            a(i10, sb2);
            sb2.append("}");
            return;
    ...
    */
    public static void e(androidx.datastore.preferences.protobuf.K r17, java.lang.StringBuilder r18, int r19) {
        /*
    ...
    public static String f(K k10, String str) {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("# ");
        sb2.append(str);
        e(k10, sb2, 0);

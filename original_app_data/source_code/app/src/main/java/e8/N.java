...
public final class N extends AbstractC3676x implements S {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f33815a[AbstractC3676x.e.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33815a[AbstractC3676x.e.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33815a[AbstractC3676x.e.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33815a[AbstractC3676x.e.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33815a[AbstractC3676x.e.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33815a[AbstractC3676x.e.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends AbstractC3676x.a implements S {
        ...
        public b t(AbstractC3661h abstractC3661h) {
            n();
            ((N) this.f31575b).V(abstractC3661h);
            return this;
        }
    ...
    public static N T(AbstractC3661h abstractC3661h, C3669p c3669p) {
        return (N) AbstractC3676x.F(DEFAULT_INSTANCE, abstractC3661h, c3669p);
    }
    ...
    public final Object q(AbstractC3676x.e eVar, Object obj, Object obj2) {
        Z bVar;
        int i10 = a.f33815a[eVar.ordinal()];
        a aVar = null;
        switch (i10) {
            case 1:
                return new N();

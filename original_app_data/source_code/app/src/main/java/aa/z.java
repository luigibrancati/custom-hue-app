...
public final class z extends AbstractC3406h1 implements K1 {
    ...
    static {
        z zVar = new z();
        zzb = zVar;
        AbstractC3406h1.C(z.class, zVar);
    }
    ...
    public final Object I(int i10, Object obj, Object obj2) {
        ...
        if (i11 == 2) {
            return AbstractC3406h1.z(zzb, "\u0004\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0001\u0000\u0001ဈ\u0000\u0002\u001b", new Object[]{"zzd", "zze", "zzf", N.class});
        }
        if (i11 == 3) {
            return new z();
        }

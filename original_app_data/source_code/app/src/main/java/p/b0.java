...
public class b0 extends AbstractC5337P {

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static boolean f41908c = false;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final WeakReference f41909b;

    public b0(Context context, Resources resources) {
        super(resources);
        this.f41909b = new WeakReference(context);
    }
    ...
    @Override // p.AbstractC5337P, android.content.res.Resources
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f41909b.get();
        return context != null ? C5336O.g().s(context, this, i10) : a(i10);
    }

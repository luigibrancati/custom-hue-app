...
public class C5358t {
    ...
    public static final int[] f41981c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final ProgressBar f41982a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public Bitmap f41983b;
    ...
    public C5358t(ProgressBar progressBar) {
        this.f41982a = progressBar;
    }
    ...
    public void c(AttributeSet attributeSet, int i10) {
        W wV = W.v(this.f41982a.getContext(), attributeSet, f41981c, i10, 0);
        Drawable drawableH = wV.h(0);
        if (drawableH != null) {
            this.f41982a.setIndeterminateDrawable(e(drawableH));
        }
        Drawable drawableH2 = wV.h(1);
        if (drawableH2 != null) {
            this.f41982a.setProgressDrawable(d(drawableH2, false));
        }
        wV.x();
    }

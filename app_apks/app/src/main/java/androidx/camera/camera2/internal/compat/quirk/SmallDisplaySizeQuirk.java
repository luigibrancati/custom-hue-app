...
public class SmallDisplaySizeQuirk implements T0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final Map f21963a;
    ...
    public static boolean e() {
        return f21963a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    public Size d() {
        return (Size) f21963a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}

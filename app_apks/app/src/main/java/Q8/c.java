...
public class c {
    ...
    public final File a() {
        if (this.f14228a == null) {
            synchronized (this) {
                try {
                    if (this.f14228a == null) {
                        this.f14228a = new File(this.f14229b.m().getFilesDir(), "PersistedInstallation." + this.f14229b.s() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) {
        try {
            ...
            File fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f14229b.m().getFilesDir());

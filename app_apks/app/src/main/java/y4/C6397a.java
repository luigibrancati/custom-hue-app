...
public final class C6397a implements D4.g {
    @Override // D4.g
    public D4.f a(D4.a amplitude, String str) {
        ...
        SharedPreferences sharedPreferences = c5488d.C().getSharedPreferences("amplitude-events-" + c5488d.l(), 0);
        String strL = c5488d.l();
        A4.a aVarA = c5488d.m().a(amplitude);
        AbstractC4862t.b(sharedPreferences);
        return new C6402f(strL, aVarA, sharedPreferences, C6401e.f48404a.a(c5488d), amplitude.n());
    }
}

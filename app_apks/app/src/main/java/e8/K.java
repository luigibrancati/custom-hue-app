...
public final class K extends AbstractC3676x implements S {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f33812a[AbstractC3676x.e.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33812a[AbstractC3676x.e.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33812a[AbstractC3676x.e.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33812a[AbstractC3676x.e.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33812a[AbstractC3676x.e.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33812a[AbstractC3676x.e.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends AbstractC3676x.a implements S {
        ...
        public b t(AbstractC3661h abstractC3661h) {
            n();
            ((K) this.f31575b).W(abstractC3661h);
            return this;
        }

        public b u(M m10) {
            n();
            ((K) this.f31575b).X(m10);
            return this;
        }
    ...
    public static K V(AbstractC3661h abstractC3661h, C3669p c3669p) {
        return (K) AbstractC3676x.F(DEFAULT_INSTANCE, abstractC3661h, c3669p);
    }
    ...
    public final Object q(AbstractC3676x.e eVar, Object obj, Object obj2) {
        Z bVar;
        int i10 = a.f33812a[eVar.ordinal()];
        a aVar = null;
        switch (i10) {
            case 1:
                return new K();

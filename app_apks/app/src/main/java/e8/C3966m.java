...
/* JADX INFO: renamed from: e8.m, reason: case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-866bacc38531af0a81fcd8a9574e1e22709cd7ce6d67b69fe3714c2addafcb5c */
/* JADX INFO: loaded from: classes3.dex */
public final class C3966m extends AbstractC3676x implements S {
    private static final C3966m DEFAULT_INSTANCE;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f33829a[AbstractC3676x.e.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33829a[AbstractC3676x.e.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33829a[AbstractC3676x.e.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33829a[AbstractC3676x.e.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33829a[AbstractC3676x.e.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33829a[AbstractC3676x.e.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
        }
    }

    /* JADX INFO: renamed from: e8.m$b */
    /* JADX INFO: compiled from: r8-map-id-866bacc38531af0a81fcd8a9574e1e22709cd7ce6d67b69fe3714c2addafcb5c */
    public static final class b extends AbstractC3676x.a implements S {
        ...
        public b t(int i10) {
            n();
            ((C3966m) this.f31575b).U(i10);
            return this;
        }

        public b() {
            super(C3966m.DEFAULT_INSTANCE);
        }
    }

    static {
        C3966m c3966m = new C3966m();
        DEFAULT_INSTANCE = c3966m;
        AbstractC3676x.L(C3966m.class, c3966m);
    }
    ...
    public static C3966m T(AbstractC3661h abstractC3661h, C3669p c3669p) {
        return (C3966m) AbstractC3676x.F(DEFAULT_INSTANCE, abstractC3661h, c3669p);
    }
    ...
    public final Object q(AbstractC3676x.e eVar, Object obj, Object obj2) {
        Z bVar;
        int i10 = a.f33829a[eVar.ordinal()];
        a aVar = null;
        switch (i10) {
            case 1:
                return new C3966m();
            case 2:
                return new b(aVar);
            case 3:
                return AbstractC3676x.D(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0002\u0003\u0002\u0000\u0000\u0000\u0002\u000b\u0003\u000b", new Object[]{"keySize_", "version_"});
            case 4:

...
class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
    ...
    public static class FlutterEngineActivityPluginBinding implements ActivityPluginBinding {
        ...
        public FlutterEngineActivityPluginBinding(Activity activity, AbstractC2754j abstractC2754j) {
            this.activity = activity;
            this.hiddenLifecycleReference = new HiddenLifecycleReference(abstractC2754j);
        }
    ...
    public static class FlutterEngineServicePluginBinding implements ServicePluginBinding {
        ...
        public FlutterEngineServicePluginBinding(Service service, AbstractC2754j abstractC2754j) {
            this.service = service;
            this.hiddenLifecycleReference = abstractC2754j != null ? new HiddenLifecycleReference(abstractC2754j) : null;
        }
    ...
    private void attachToActivityInternal(Activity activity, AbstractC2754j abstractC2754j) {
        this.activityPluginBinding = new FlutterEngineActivityPluginBinding(activity, abstractC2754j);
    ...
    public void attachToActivity(ExclusiveAppComponent<Activity> exclusiveAppComponent, AbstractC2754j abstractC2754j) {
        ...
        try {
            ...
            attachToActivityInternal(exclusiveAppComponent.getAppComponent(), abstractC2754j);
            if (traceSectionScoped != null) {
                traceSectionScoped.close();
            }
        } catch (Throwable th) {
    ...
    public void attachToBroadcastReceiver(BroadcastReceiver broadcastReceiver, AbstractC2754j abstractC2754j) {
    ...
    public void attachToContentProvider(ContentProvider contentProvider, AbstractC2754j abstractC2754j) {
    ...
    public void attachToService(Service service, AbstractC2754j abstractC2754j, boolean z10) {
        TraceSection traceSectionScoped = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToService");
        try {
            detachFromAppComponent();
            this.service = service;
            this.servicePluginBinding = new FlutterEngineServicePluginBinding(service, abstractC2754j);

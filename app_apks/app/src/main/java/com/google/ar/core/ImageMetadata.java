...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i10, q qVar) {
        long jNativeGetMetadataEntry = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i10);
        qVar.f31214a = jNativeGetMetadataEntry;
        if (jNativeGetMetadataEntry == 0) {
            throw new IllegalArgumentException(String.format("Invalid ImageMetadata key: %1$d", Integer.valueOf(i10)));
        }
        qVar.f31215b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, jNativeGetMetadataEntry);
        qVar.f31216c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, qVar.f31214a);
    }
    ...
    public byte getByte(int i10) {
        ...
        if (qVar.f31215b != 0 || qVar.f31216c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        byte bNativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public byte[] getByteArray(int i10) {
        ...
        byte[] bArrNativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public double getDouble(int i10) {
        getMetdataEntry(i10, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f31215b != 4 || qVar.f31216c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        double dNativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public double[] getDoubleArray(int i10) {
        ...
        double[] dArrNativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public float getFloat(int i10) {
        getMetdataEntry(i10, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f31215b != 2 || qVar.f31216c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        float fNativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public float[] getFloatArray(int i10) {
        ...
        float[] fArrNativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public int getInt(int i10) {
        getMetdataEntry(i10, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f31215b != 1 || qVar.f31216c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        int iNativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public int[] getIntArray(int i10) {
        ...
        int[] iArrNativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public long getLong(int i10) {
        getMetdataEntry(i10, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f31215b != 3 || qVar.f31216c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", Integer.valueOf(i10), Integer.valueOf(this.sketchEntry.f31215b), Integer.valueOf(this.sketchEntry.f31216c)));
        }
        long jNativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public long[] getLongArray(int i10) {
        ...
        long[] jArrNativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public Rational getRational(int i10) {
        getMetdataEntry(i10, this.sketchEntry);
        q qVar = this.sketchEntry;
        if (qVar.f31215b != 5 || qVar.f31216c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        Rational rationalNativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
    ...
    public Rational[] getRationalArray(int i10) {
        ...
        Rational[] rationalArrNativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, qVar.f31214a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f31214a);
        return rationalArrNativeGetRationalArrayFromMetadataEntry;
    }

    public ImageMetadata(long j10, Session session) {

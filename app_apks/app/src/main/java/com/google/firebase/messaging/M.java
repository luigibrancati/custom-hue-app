...
public class M {
    ...
    public final Bundle f31627a;

    public M(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f31627a = new Bundle(bundle);
    }
    ...
    public String p(String str) {
        return this.f31627a.getString(w(str));
    }
    ...
    public final String w(String str) {
        if (!this.f31627a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f31627a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f31627a);
        for (String str : this.f31627a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }

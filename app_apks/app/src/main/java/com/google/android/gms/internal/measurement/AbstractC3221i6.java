...
public abstract class AbstractC3221i6 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final /* synthetic */ int f29501a = 0;

    static {
        if (AbstractC3194f6.f() && AbstractC3194f6.g()) {
    ...
    */
    public static boolean a(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.AbstractC3221i6.a(byte[], int, int):boolean");
    }
        ...
        while (i15 < length) {
            ...
            if (cCharAt2 < 128 && i16 < i12) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i16 > i12 - 3) {
                    ...
                    throw new C3212h6(i15 - 1, length);
                }

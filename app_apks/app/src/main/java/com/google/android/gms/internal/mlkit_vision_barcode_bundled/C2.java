...
public abstract class C2 {
    ...
    public static final AbstractC3496z2 f29744a;

    static {
        if (AbstractC3481w2.C() && AbstractC3481w2.D()) {
            int i10 = AbstractC3469u0.f29942a;
        }
        f29744a = new A2();
    }

    public static /* bridge */ /* synthetic */ int c(byte[] bArr, int i10, int i11) {
        int i12 = i11 - i10;
        byte b10 = bArr[i10 - 1];
        if (i12 == 0) {
            if (b10 > -12) {
    ...
    public static int f(int i10, byte[] bArr, int i11, int i12) {
        return f29744a.a(i10, bArr, i11, i12);
    }

    public static boolean g(byte[] bArr, int i10, int i11) {
        return f29744a.a(0, bArr, i10, i11) == 0;
    }

...
public final class C3466t2 extends AbstractC3476v2 {
    public C3466t2(Unsafe unsafe) {
        super(unsafe);
    }
    ...
    public final void c(Object obj, long j10, boolean z10) {
        if (AbstractC3481w2.f29965h) {
            AbstractC3481w2.d(obj, j10, z10 ? (byte) 1 : (byte) 0);
        } else {
            AbstractC3481w2.e(obj, j10, z10 ? (byte) 1 : (byte) 0);
        }
    }

...
public abstract class T {
    ...
    public static final char[] f31400a;
    ...
    public static boolean b(Object obj) {
        return obj instanceof Boolean ? !((Boolean) obj).booleanValue() : obj instanceof Integer ? ((Integer) obj).intValue() == 0 : obj instanceof Float ? Float.floatToRawIntBits(((Float) obj).floatValue()) == 0 : obj instanceof Double ? Double.doubleToRawLongBits(((Double) obj).doubleValue()) == 0 : obj instanceof String ? obj.equals("") : obj instanceof AbstractC3661h ? obj.equals(AbstractC3661h.f31448b) : obj instanceof Q ? obj == ((Q) obj).getDefaultInstanceForType() : (obj instanceof Enum) && ((Enum) obj).ordinal() == 0;
    }
    ...
    public static void d(StringBuilder sb2, int i10, String str, Object obj) {
        ...
        if (obj instanceof AbstractC3661h) {
            sb2.append(": \"");
            sb2.append(k0.a((AbstractC3661h) obj));
            sb2.append(JsonFactory.DEFAULT_QUOTE_CHAR);
            return;
        }
        if (obj instanceof AbstractC3676x) {
            sb2.append(" {");
            e((AbstractC3676x) obj, sb2, i10 + 2);
            sb2.append("\n");
            a(i10, sb2);
            sb2.append("}");
            return;
    ...
    */
    public static void e(com.google.crypto.tink.shaded.protobuf.Q r17, java.lang.StringBuilder r18, int r19) {
        /*
    ...
    public static String f(Q q10, String str) {
        StringBuilder sb2 = new StringBuilder();
        sb2.append("# ");
        sb2.append(str);
        e(q10, sb2, 0);

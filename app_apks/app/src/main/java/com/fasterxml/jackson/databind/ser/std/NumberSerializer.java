...
public class NumberSerializer extends StdScalarSerializer<Number> implements ContextualSerializer {
    ...
    /* JADX INFO: renamed from: com.fasterxml.jackson.databind.ser.std.NumberSerializer$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-866bacc38531af0a81fcd8a9574e1e22709cd7ce6d67b69fe3714c2addafcb5c */
    ...
    public static final class BigDecimalAsStringSerializer extends ToStringSerializerBase {
        ...
        public void serialize(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws JsonMappingException {
            String string;
            Integer numValueOf = Integer.valueOf(NumberSerializer.MAX_BIG_DECIMAL_SCALE);
            if (jsonGenerator.isEnabled(JsonGenerator.Feature.WRITE_BIGDECIMAL_AS_PLAIN)) {
                ...
                if (!_verifyBigDecimalRange(jsonGenerator, bigDecimal)) {
                    serializerProvider.reportMappingProblem(String.format("Attempt to write plain `java.math.BigDecimal` (see JsonGenerator.Feature.WRITE_BIGDECIMAL_AS_PLAIN) with illegal scale (%d): needs to be between [-%d, %d]", Integer.valueOf(bigDecimal.scale()), numValueOf, numValueOf), new Object[0]);
                }

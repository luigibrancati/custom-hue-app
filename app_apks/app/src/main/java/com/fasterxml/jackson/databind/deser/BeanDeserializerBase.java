...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, ValueInstantiator.Gettable, Serializable {
    ...
    public NameTransformer _findPropertyUnwrapper(DeserializationContext deserializationContext, SettableBeanProperty settableBeanProperty) throws InvalidDefinitionException {
    ...
    */
    public com.fasterxml.jackson.databind.deser.SettableBeanProperty _resolveMergeAndNullSettings(com.fasterxml.jackson.databind.DeserializationContext r4, com.fasterxml.jackson.databind.deser.SettableBeanProperty r5, com.fasterxml.jackson.databind.PropertyMetadata r6) throws com.fasterxml.jackson.databind.exc.InvalidDefinitionException {
        ...
        L3a:
            com.fasterxml.jackson.databind.deser.NullValueProvider r3 = r3.findValueNullProvider(r4, r5, r6)
            if (r3 == 0) goto L45
            com.fasterxml.jackson.databind.deser.SettableBeanProperty r3 = r5.withNullProvider(r3)
            return r3
        L45:
            return r5
        */
    ...
    public Iterator<SettableBeanProperty> creatorProperties() {
        ...
        return propertyBasedCreator == null ? Collections.EMPTY_LIST.iterator() : propertyBasedCreator.properties().iterator();
    }
    ...
    public Object handlePolymorphic(JsonParser jsonParser, DeserializationContext deserializationContext, Object obj, TokenBuffer tokenBuffer) throws IgnoredPropertyException {
    ...
    public BeanDeserializerBase withIgnoreAllUnknown(boolean z10) {
        return z10 == this._ignoreAllUnknown ? this : withIgnorableProperties(this._ignorableProps);
    }

    public abstract BeanDeserializerBase withObjectIdReader(ObjectIdReader objectIdReader);

    public void wrapAndThrow(Throwable th, Object obj, String str, DeserializationContext deserializationContext) throws JsonMappingException {

...
public final /* synthetic */ class PluginController$pluginMethods$11 extends AbstractC4860q implements vc.p {
    ...
    public final void invoke(MethodCall p02, MethodChannel.Result p12) {
        ...
        ((PluginController) this.receiver).stopNotifications(p02, p12);
    }
}

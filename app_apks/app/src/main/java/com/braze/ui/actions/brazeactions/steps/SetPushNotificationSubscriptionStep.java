...
public final class SetPushNotificationSubscriptionStep extends BaseBrazeActionStep {
    ...
    public void run(Context context, final StepData data) {
        ...
        if (notificationSubscriptionTypeFromValue == null) {
            BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, (Object) this, (BrazeLogger.Priority) null, (Throwable) null, false, new InterfaceC6082a() { // from class: B5.i
                @Override // vc.InterfaceC6082a
                public final Object invoke() {
                    return SetPushNotificationSubscriptionStep.run$lambda$1(data);
                }
            }, 7, (Object) null);
        } else {
            BaseBrazeActionStep.INSTANCE.runOnUser$android_sdk_ui_release(Braze.INSTANCE.getInstance(context), new l() { // from class: B5.j
                @Override // vc.l
                public final Object invoke(Object obj) {
                    return SetPushNotificationSubscriptionStep.run$lambda$2(notificationSubscriptionTypeFromValue, (BrazeUser) obj);
                }
            });
        }
    }

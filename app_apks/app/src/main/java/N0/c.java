...
public abstract class c {
    ...
    public static ColorStateList d(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray typedArrayG = g(resources2, theme, attributeSet, K0.f.f6714b);
                int resourceId = typedArrayG.getResourceId(K0.f.f6715c, -1);
                if (resourceId == -1 || e(resources2, resourceId)) {
                    color = typedArrayG.getColor(K0.f.f6715c, -65281);
                } else {
                    try {
                ...
                float f10 = 1.0f;
                if (typedArrayG.hasValue(K0.f.f6716d)) {
                    f10 = typedArrayG.getFloat(K0.f.f6716d, 1.0f);
                } else if (typedArrayG.hasValue(K0.f.f6718f)) {
                    f10 = typedArrayG.getFloat(K0.f.f6718f, 1.0f);
                }
                float f11 = typedArrayG.hasValue(K0.f.f6717e) ? typedArrayG.getFloat(K0.f.f6717e, -1.0f) : typedArrayG.getFloat(K0.f.f6719g, -1.0f);
                typedArrayG.recycle();
                ...
                for (int i13 = 0; i13 < attributeCount; i13++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != K0.a.f6653a && attributeNameResource != K0.a.f6654b) {
                        int i14 = i12 + 1;
    ...
    public static int f(int i10, float f10, float f11) {
        ...
        int iC = S0.a.c((int) ((Color.alpha(i10) * f10) + 0.5f), 0, 255);
        if (z10) {
            a aVarC = a.c(i10);
            i10 = a.m(aVarC.j(), aVarC.i(), f11);
        }
        return (i10 & 16777215) | (iC << 24);
    }

...
public abstract class AbstractC0839a {
    ...
    public static final byte[] f4091a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final byte[] f4092b;

    static {
        C0846h.a aVar = C0846h.f4117d;
        f4091a = aVar.d("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/").s();
        f4092b = aVar.d("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_").s();
    }
    ...
    public static final String b(byte[] bArr, byte[] map) {
        ...
        while (i10 < length) {
            ...
            bArr2[i11 + 1] = map[((b10 & 3) << 4) | ((b11 & ForkServer.ERROR) >> 4)];
            int i13 = i11 + 3;
            bArr2[i11 + 2] = map[((b11 & 15) << 2) | ((b12 & ForkServer.ERROR) >> 6)];
            i11 += 4;
        ...
        if (length2 == 1) {
            ...
            byte b14 = bArr[i10];
            byte b15 = bArr[i14];
            bArr2[i11] = map[(b14 & ForkServer.ERROR) >> 2];
            bArr2[i11 + 1] = map[((b14 & 3) << 4) | ((b15 & ForkServer.ERROR) >> 4)];

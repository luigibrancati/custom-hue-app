...
public abstract class L {
    public static byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        while (i12 < bArr2.length) {
            ...
            long j19 = jC2;
            long jC10 = j17 + (c(bArr3, 12, 8) | ((long) (bArr3[16] << 24)));
        ...
        long j57 = (j47 | (j40 & j52) | (j53 << 26)) & KeyboardMap.kValueMask;
        long j58 = ((j53 >> 6) | (j54 << 20)) & KeyboardMap.kValueMask;
        long j59 = ((j54 >> 12) | (j55 << 14)) & KeyboardMap.kValueMask;
        long j60 = ((j55 >> 18) | (j56 << 8)) & KeyboardMap.kValueMask;
        long jD = j57 + d(bArr, 16);
        long j61 = jD & KeyboardMap.kValueMask;
        long jD2 = j58 + d(bArr, 20) + (jD >> 32);
        long j62 = jD2 & KeyboardMap.kValueMask;
        long jD3 = j59 + d(bArr, 24) + (jD2 >> 32);
        long j63 = jD3 & KeyboardMap.kValueMask;
        long jD4 = (j60 + d(bArr, 28) + (jD3 >> 32)) & KeyboardMap.kValueMask;
    ...
    public static long d(byte[] bArr, int i10) {
        return ((long) (((bArr[i10 + 3] & ForkServer.ERROR) << 24) | (bArr[i10] & ForkServer.ERROR) | ((bArr[i10 + 1] & ForkServer.ERROR) << 8) | ((bArr[i10 + 2] & ForkServer.ERROR) << 16))) & KeyboardMap.kValueMask;
    }

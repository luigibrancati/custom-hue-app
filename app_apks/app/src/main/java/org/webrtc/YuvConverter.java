...
public final class YuvConverter {
    ...
    private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer textureBuffer) {
        ...
        int i11 = (height + 1) / 2;
        int i12 = height + i11;
        final ByteBuffer byteBufferNativeAllocateByteBuffer = JniCommon.nativeAllocateByteBuffer(i10 * i12);
        int i13 = i10 / 4;
        ...
        byteBufferNativeAllocateByteBuffer.limit(i15 + i18);
        ByteBuffer byteBufferSlice2 = byteBufferNativeAllocateByteBuffer.slice();
        byteBufferNativeAllocateByteBuffer.position(i17);
        byteBufferNativeAllocateByteBuffer.limit(i17 + i18);
        ByteBuffer byteBufferSlice3 = byteBufferNativeAllocateByteBuffer.slice();
        textureBuffer2.release();
        return JavaI420Buffer.wrap(width, height, byteBufferSlice, i10, byteBufferSlice2, i10, byteBufferSlice3, i10, new Runnable() { // from class: org.webrtc.m0

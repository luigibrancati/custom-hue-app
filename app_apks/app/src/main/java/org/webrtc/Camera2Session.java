...
class Camera2Session implements CameraSession {
    ...
    public static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.d(Camera2Session.TAG, "Capture failed: " + String.valueOf(captureFailure));
        }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to create capture session. " + String.valueOf(e10));
            }
        }
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.d
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        this.f41681a.lambda$onConfigured$0(videoFrame);
                    }
                });
                Logging.d(Camera2Session.TAG, "Camera device successfully started.");
                Camera2Session.this.callback.onDone(Camera2Session.this);
            } catch (CameraAccessException e10) {
                Camera2Session.this.reportError("Failed to start capture request. " + String.valueOf(e10));
            }
        }
    ...
    private void findCaptureFormat() {
        ...
        Logging.d(TAG, "Available preview sizes: " + String.valueOf(supportedSizes));
        Logging.d(TAG, "Available fps ranges: " + String.valueOf(listConvertFramerates));
        ...
        Logging.d(TAG, "Using capture format: " + String.valueOf(captureFormat));
    }
    ...
    private void openCamera() {
        ...
        try {
            ...
            reportError("Failed to open camera: " + String.valueOf(e10));
        }
    }

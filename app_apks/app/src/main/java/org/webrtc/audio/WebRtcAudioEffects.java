    ...
    public void enable(int i10) {
        ...
        if (isAcousticEchoCancelerSupported()) {
            ...
            if (acousticEchoCancelerCreate != null) {
                ...
                Logging.d(TAG, "AcousticEchoCanceler: was " + (enabled ? "enabled" : "disabled") + ", enable: " + z11 + ", is now: " + (this.aec.getEnabled() ? "enabled" : "disabled"));
            } else {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            Logging.d(TAG, "NoiseSuppressor: was " + (enabled2 ? "enabled" : "disabled") + ", enable: " + z10 + ", is now: " + (this.ns.getEnabled() ? "enabled" : "disabled"));
        }
    }

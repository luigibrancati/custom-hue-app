...
public final class C2605a implements FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    public void onAttachedToEngine(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        ...
        MethodChannel methodChannel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "dtls_client");
    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        ...
        if (!AbstractC4862t.a(call.method, "getPlatformVersion")) {

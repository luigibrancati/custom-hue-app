...
public abstract class AbstractC4760a {
    ...
    public static final boolean f39153a;
    ...
    public static byte[] d(byte[] bArr) {
        ...
        for (int i12 = 0; i12 < length; i12++) {
            int i13 = i10 + 1;
            int i14 = i11 + 1;
            bArr2[i12] = (byte) (((bArr[i10] & ForkServer.ERROR) >>> i11) + ((bArr[i13] & ((1 << i14) - 1)) << (7 - i11)));
            if (i11 == 6) {
                i10 += 2;
                i11 = 0;
            } else {
    ...
    public static byte[] e(String[] strArr) {
        ...
        if (strArr.length > 0 && !strArr[0].isEmpty()) {
            ...
            if (cCharAt == 0) {
                byte[] bArrA = AbstractC4769j.a(f(strArr));
                if (bArrA == null) {
                    a(8);
                }
                return bArrA;

...
public abstract class b {
    ...
    public static final double f9367a = Math.log(2.0d);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final double[] f9368b = {1.0d, 2.0922789888E13d, 2.631308369336935E35d, 1.2413915592536073E61d, 1.2688693218588417E89d, 7.156945704626381E118d, 9.916779348709496E149d, 1.974506857221074E182d, 3.856204823625804E215d, 5.5502938327393044E249d, 4.7147236359920616E284d};
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f9369a[RoundingMode.FLOOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9369a[RoundingMode.CEILING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9369a[RoundingMode.DOWN.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9369a[RoundingMode.UP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9369a[RoundingMode.HALF_EVEN.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9369a[RoundingMode.HALF_UP.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f9369a[RoundingMode.HALF_DOWN.ordinal()] = 8;
    ...
    */
    public static int d(double r5, java.math.RoundingMode r7) {
        ...
        L6b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: M7.b.d(double, java.math.RoundingMode):int");
    }
    ...
    public static double e(double d10, RoundingMode roundingMode) {
        ...
        switch (a.f9369a[roundingMode.ordinal()]) {
            case 1:
                f.f(b(d10));
                return d10;
            case 2:

...
public abstract class c {
    ...
    public static void k(Parcel parcel, int i10, float[] fArr, boolean z10) {
        if (fArr == null) {
            if (z10) {
                B(parcel, i10, 0);
            }
    ...
    public static void z(Parcel parcel, int i10, Parcelable[] parcelableArr, int i11, boolean z10) {

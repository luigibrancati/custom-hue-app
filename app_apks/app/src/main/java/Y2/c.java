...
public abstract class c {
    ...
    public static byte[] e(InputStream inputStream, int i10, int i11) {
        ...
        try {
            ...
            byte[] bArr2 = new byte[RecognitionOptions.PDF417];
            int i12 = 0;
            int iInflate = 0;
    ...
    public static long g(InputStream inputStream, int i10) throws IOException {
        byte[] bArrD = d(inputStream, i10);
        long j10 = 0;
        for (int i11 = 0; i11 < i10; i11++) {
            j10 += ((long) (bArrD[i11] & ForkServer.ERROR)) << (i11 * 8);
        }
        return j10;
    }
    ...
    public static void o(OutputStream outputStream, long j10, int i10) throws IOException {
        byte[] bArr = new byte[i10];
        for (int i11 = 0; i11 < i10; i11++) {
